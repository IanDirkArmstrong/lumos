// Lumos - UI theme (VS Code inspired)
...
inline void ApplyVSCodeTheme()
{
    ...
    colors[ImGuiCol_Separator]              = ImVec4(0.28f, 0.28f, 0.28f, 0.50f);
    ...
    colors[ImGuiCol_TabUnfocusedActive]     = ImVec4(0.15f, 0.31f, 0.42f, 1.00f);
    ...
    // Style adjustments to match VS Code
